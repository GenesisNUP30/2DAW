<form action="ej32.php" method="post">
    Nombre: <input type="text" name="nombre" 
        value="<?= isset($_POST['nombre']) ? $_POST['nombre'] : '' ?>"><br><br>

    Apellidos: <input type="text" name="apellidos" 
        value="<?= isset($_POST['apellidos']) ? $_POST['apellidos'] : '' ?>"><br><br>
    ...
    <input type="date" name="fecha"
        value="<?= isset($_POST['fecha']) ? $_POST['fecha'] : '' ?>"><br><br>

    Observaciones:<br>
    <textarea name="observaciones" rows="5" cols="40"><?= isset($_POST['observaciones']) ? $_POST['observaciones'] : '' ?></textarea><br><br>
