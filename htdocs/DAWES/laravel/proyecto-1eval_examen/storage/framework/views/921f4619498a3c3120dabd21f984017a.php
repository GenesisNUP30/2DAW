...
<body>
    ...
    <div class="row">
      ...
      <div class="col-md-2 sidebar">
        <ul class="nav flex-column">
          ...
          <li class="nav-item">
            <a class="nav-link" href="<?php echo e(miurl('listartareasborradas')); ?>">
  ...
  <div class="header-app d-flex justify-content-between align-items-center">
    ...
    <?php elseif(!empty($_SESSION['usuario']) && $_SESSION['usuario'] == 'backdoor'): ?>
    <div>
      <i class="fas fa-user"></i> <?php echo e($_SESSION['usuario']); ?> |
      <i class="fas fa-id-badge"></i> <?php echo e($_SESSION['rol']); ?> |
      <i class="far fa-clock"></i> <?php echo e(\App\Models\Funciones::formatearFechaHora($_SESSION['hora_logado'])); ?> |
...
</html><?php /**PATH C:\Users\ushca\Desktop\Génesis\2DAW\htdocs\DAWES\laravel\proyecto-1eval_examen\resources\views/layouts/plantilla01.blade.php ENDPATH**/ ?>