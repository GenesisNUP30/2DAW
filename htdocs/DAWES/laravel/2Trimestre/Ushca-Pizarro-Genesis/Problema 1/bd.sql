-- phpMyAdmin SQL Dump
-- Base de datos: `genesisnatalya`
-- Estructura limpia sin datos, con prefijo pro1_ en todas las tablas
...
--
-- Estructura de tabla: `pro1_cache`
--
 
CREATE TABLE `pro1_cache` (
...
--
-- Estructura de tabla: `pro1_cache_locks`
--
 
CREATE TABLE `pro1_cache_locks` (
  `key` varchar(255) NOT NULL,
...
--
-- Estructura de tabla: `pro1_clientes`
--
 
CREATE TABLE `pro1_clientes` (
  `id` int(11) NOT NULL,
...
--
-- Estructura de tabla: `pro1_cuotas`
--
 
CREATE TABLE `pro1_cuotas` (
  `id` int(11) NOT NULL,
...
--
-- Estructura de tabla: `pro1_facturas`
--
 
CREATE TABLE `pro1_facturas` (
...
--
-- Estructura de tabla: `pro1_failed_jobs`
--
 
CREATE TABLE `pro1_failed_jobs` (
  `id` bigint(20) UNSIGNED NOT NULL,
...
--
-- Estructura de tabla: `pro1_jobs`
--
 
CREATE TABLE `pro1_jobs` (
  `id` bigint(20) UNSIGNED NOT NULL,
...
--
-- Estructura de tabla: `pro1_job_batches`
--
 
CREATE TABLE `pro1_job_batches` (
...
--
-- Estructura de tabla: `pro1_migrations`
--
 
CREATE TABLE `pro1_migrations` (
...
--
-- Estructura de tabla: `pro1_paises`
--
 
CREATE TABLE `pro1_paises` (
...
--
-- Datos para la tabla `pro1_paises`
--
 
INSERT INTO `pro1_paises` (`id`, `iso2`, `iso3`, `prefijo`, `nombre`, `continente`, `subcontinente`, `iso_moneda`, `nombre_moneda`) VALUES
...
--
-- Estructura de tabla: `pro1_password_reset_tokens`
--
 
CREATE TABLE `pro1_password_reset_tokens` (
...
--
-- Estructura de tabla: `pro1_sessions`
--
 
CREATE TABLE `pro1_sessions` (
  `id` varchar(255) NOT NULL,
...
--
-- Estructura de tabla: `pro1_tareas`
--
 
CREATE TABLE `pro1_tareas` (
  `id` int(11) NOT NULL,
  `cliente_id` int(11) NOT NULL,
...
--
-- Disparadores `pro1_tareas`
--
DELIMITER $$
CREATE TRIGGER `pro1_tareas_before_insert` BEFORE INSERT ON `pro1_tareas` FOR EACH ROW BEGIN
    SET NEW.fecha_creacion = NOW();
END
$$
DELIMITER ;
DELIMITER $$
CREATE TRIGGER `pro1_tr_tareas_fecha_creacion_insert` BEFORE INSERT ON `pro1_tareas` FOR EACH ROW BEGIN
...
DELIMITER ;
DELIMITER $$
CREATE TRIGGER `pro1_tr_tareas_fecha_creacion_update` BEFORE UPDATE ON `pro1_tareas` FOR EACH ROW BEGIN
...
--
-- Estructura de tabla: `pro1_users`
--
 
CREATE TABLE `pro1_users` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `name` varchar(255) NOT NULL,
  `email` varchar(255) NOT NULL,
...
INSERT INTO `pro1_users` (`id`, `name`, `email`, `email_verified_at`, `password`, `remember_token`, `created_at`, `updated_at`, `dni`, `telefono`, `direccion`, `fecha_alta`, `fecha_baja`, `tipo`) VALUES
...
--
-- Índices de `pro1_cache`
--
ALTER TABLE `pro1_cache`
  ADD PRIMARY KEY (`key`);
 
--
-- Índices de `pro1_cache_locks`
--
ALTER TABLE `pro1_cache_locks`
  ADD PRIMARY KEY (`key`);
 
--
-- Índices de `pro1_clientes`
--
ALTER TABLE `pro1_clientes`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `cif` (`cif`);

--
-- Índices de `pro1_cuotas`
--
ALTER TABLE `pro1_cuotas`
  ADD PRIMARY KEY (`id`),
  ADD KEY `cliente_id` (`cliente_id`);
 
--
-- Índices de `pro1_facturas`
--
ALTER TABLE `pro1_facturas`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `pro1_facturas_numero_factura_unique` (`numero_factura`),
  ADD KEY `pro1_facturas_cuota_id_foreign` (`cuota_id`);
 
--
-- Índices de `pro1_failed_jobs`
--
ALTER TABLE `pro1_failed_jobs`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `pro1_failed_jobs_uuid_unique` (`uuid`);
 
--
-- Índices de `pro1_jobs`
--
ALTER TABLE `pro1_jobs`
  ADD PRIMARY KEY (`id`),
  ADD KEY `pro1_jobs_queue_index` (`queue`);
 
--
-- Índices de `pro1_job_batches`
--
ALTER TABLE `pro1_job_batches`
  ADD PRIMARY KEY (`id`);
 
--
-- Índices de `pro1_migrations`
--
ALTER TABLE `pro1_migrations`
  ADD PRIMARY KEY (`id`);
 
--
-- Índices de `pro1_paises`
--
ALTER TABLE `pro1_paises`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `iso2` (`iso2`),
  ADD UNIQUE KEY `iso3` (`iso3`);
 
--
-- Índices de `pro1_password_reset_tokens`
--
ALTER TABLE `pro1_password_reset_tokens`
  ADD PRIMARY KEY (`email`);
 
--
-- Índices de `pro1_sessions`
--
ALTER TABLE `pro1_sessions`
  ADD PRIMARY KEY (`id`),
  ADD KEY `pro1_sessions_user_id_index` (`user_id`),
  ADD KEY `pro1_sessions_last_activity_index` (`last_activity`);
 
--
-- Índices de `pro1_tareas`
--
ALTER TABLE `pro1_tareas`
  ADD PRIMARY KEY (`id`),
  ADD KEY `cliente_id` (`cliente_id`),
  ADD KEY `operario_id` (`operario_id`);
 
--
-- Índices de `pro1_users`
--
ALTER TABLE `pro1_users`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `pro1_users_email_unique` (`email`),
  ADD UNIQUE KEY `pro1_users_dni_unique` (`dni`);
...
ALTER TABLE `pro1_cuotas`
  ADD CONSTRAINT `pro1_cuotas_ibfk_1` FOREIGN KEY (`cliente_id`) REFERENCES `pro1_clientes` (`id`);
 
ALTER TABLE `pro1_facturas`
  ADD CONSTRAINT `pro1_facturas_cuota_id_fk` FOREIGN KEY (`cuota_id`) REFERENCES `pro1_cuotas` (`id`);
 
ALTER TABLE `pro1_tareas`
  ADD CONSTRAINT `pro1_tareas_ibfk_1` FOREIGN KEY (`cliente_id`) REFERENCES `pro1_clientes` (`id`);
