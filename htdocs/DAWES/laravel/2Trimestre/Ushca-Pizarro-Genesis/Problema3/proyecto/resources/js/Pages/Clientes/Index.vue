                ...
                <div class="p-6 overflow-y-auto">
                    ...
                    >
                        ...
                        <div class="md:col-span-2">
                            <label
                                class="block text-xs font-bold uppercase text-gray-500 mb-1"
                                >Cuenta Corriente (IBAN)</label
                            >
                            <input
                                v-model="form.cuenta_corriente"
                                :disabled="soloLectura"
                                type="text"
                                :class="{
                                    'border-red-500 ring-1 ring-red-500':
                                        form.errors.cuenta_corriente,
                                    'bg-gray-50 cursor-not-allowed':
                                        soloLectura,
                                }"
                                class="w-full border-gray-300 rounded-lg shadow-sm p-2.5 border text-sm"
                            />
                            <p
                                v-if="form.errors.cuenta_corriente"
                                class="text-red-500 text-[11px] mt-1"
                            >
                                {{ form.errors.cuenta_corriente }}
                            </p>
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                >
                                <input
                                    v-model.number="form.importe_cuota_mensual"
                                    :disabled="soloLectura"
                                    type="number"
                                    step="0.01"
                                    :class="{
                                        'border-red-500 ring-1 ring-red-500':
                                            form.errors.importe_cuota_mensual,
                                        'bg-gray-50 cursor-not-allowed':
                                            soloLectura,
                                    }"
                            ...
                            <p
                                v-if="form.errors.importe_cuota_mensual"
                                class="text-red-500 text-[11px] mt-1"
                            >
                                {{ form.errors.importe_cuota_mensual }}
                            </p>
        ...
        >
            ...
            >
                ...
                <div class="p-6">
                    ...
                    <div
                        class="bg-amber-50 border-l-4 border-amber-500 p-3 mb-4"
                    >
                        <div class="flex">
                            <div class="flex-shrink-0">
                                <i
                                    class="fas fa-info-circle text-amber-500"
                                ></i>
                            </div>
                            <div class="ml-3">
                                <p
                                    class="text-xs text-amber-800 font-bold uppercase"
                                >
                                    Aviso
                                </p>
                                <p class="text-xs text-amber-700 mt-1">
                                    Esta acción también marcará como eliminadas
                                    todas las
                                    <strong>cuotas asociadas</strong> a este
                                    cliente.
                                </p>
                            </div>
                        </div>
