...
<div class="container-fluid px-4 py-3">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h2 class="fw-bold m-0">
            <i class="fas fa-user-tie me-2 text-dark"></i>Listado de clientes
        </h2>
    ...
    <div class="d-flex flex-wrap gap-3 mb-4 align-items-center">
        ...
        <div class="d-flex gap-2 align-items-center">
            <span class="text-muted small fw-bold text-uppercase" style="font-size: 0.65rem;">Estado:</span>
            ...
            <a href="{{ request()->fullUrlWithQuery(['estado' => '']) }}"
                ...
                style="font-size: 0.75rem; padding: 6px 14px;">Todos</a>

            <a href="{{ request()->fullUrlWithQuery(['estado' => 'activos']) }}"
                class="badge rounded-pill text-decoration-none border {{ $est == 'activos' ? 'bg-success text-white border-success shadow-sm' : 'bg-white text-muted border-secondary' }}"
                style="font-size: 0.75rem; padding: 6px 14px;">Activos</a>
            ...
            <a href="{{ request()->fullUrlWithQuery(['estado' => 'baja']) }}"
                ...
                style="font-size: 0.75rem; padding: 6px 14px;">En Baja</a>
        </div>
        ...
        {{-- Grupo de Pagos --}}
        <div class="d-flex gap-2 align-items-center">
            <span class="text-muted small fw-bold text-uppercase" style="font-size: 0.65rem;">Pagos:</span>
            ...
            <tbody>
                ...
                <tr style="border-top: 1px solid #f3f4f6;">
                    ...
                    <td class="ps-4">
                        ...
                        <div class="text-muted x-small" style="font-size: 0.75rem;">{{ $cliente->cif }}</div>
                    </td>

                    {{-- Contacto --}}
                    <td>
                        <div class="small text-dark"><i class="fas fa-phone-alt me-1 opacity-50"></i> {{ $cliente->telefono }}</div>
                        <div class="text-muted x-small" style="font-size: 0.75rem;">{{ $cliente->correo }}</div>
                    </td>
                    ...
                    <td class="text-center">
                        ...
                        <span class="badge bg-danger bg-opacity-10 text-danger rounded-pill border border-danger border-opacity-25"
                            style="font-size: 0.65rem;" title="Tiene cobros pendientes">
                    ...
                    <td>
                        @if($cliente->isActivo())
                        <span class="badge rounded-pill bg-success bg-opacity-10 text-success border border-success border-opacity-25" style="font-size: 0.7rem; padding: 4px 10px;">
                            Activo
                        </span>
                        @else
                        <span class="badge rounded-pill bg-secondary bg-opacity-10 text-secondary border border-secondary border-opacity-25" style="font-size: 0.7rem; padding: 4px 10px;">
                            En baja
                        </span>
                        @endif
                    </td>
                    ...
                    <td class="pe-4">
                        <div class="d-flex gap-1 justify-content-end">
                            ...
                            <a href="{{ route('clientes.confirmBaja', $cliente) }}"
                                ...
                                style="width:32px; height:32px; display:flex; align-items:center; justify-content:center;"
                                title="Dar de baja">
                                <i class="fas fa-user-minus text-warning" style="font-size: 12px;"></i>
                            </a>
                            @else
