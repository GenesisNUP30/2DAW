    <form action="" method="POST" enctype="multipart/form-data">
        ...
        <input type="text" name="nifCif" value="<?php echo e($nifCif); ?>"><br>
        <?php echo \App\Models\Funciones::verErrores('nif_cif'); ?>

        <br>

        <label>Persona de contacto:</label><br>
        <input type="text" name="personaNombre" value="<?php echo e($personaNombre); ?>"><br>
        <?php echo \App\Models\Funciones::verErrores('nombre_persona'); ?>
        ...
        <?php echo \App\Models\Funciones::verErrores('descripcion_tarea'); ?>
        ...
        <?php echo \App\Models\Funciones::verErrores('fechaRealizacion'); ?>
        ...
        <a class="btn btn-cancel" href="<?php echo url('/'); ?>">Cancelar</a>  <input type="submit" value="Crear tarea">
    </form>
<?php /**PATH C:\Users\ushca\Desktop\Génesis\2DAW\htdocs\DAWES\laravel\Laravel_RutasyBlade-EjemploGenesis\resources\views/form.blade.php ENDPATH**/ ?>